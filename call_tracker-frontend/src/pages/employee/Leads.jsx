...
export default function Leads() {
  ...
  const convertToFollowUp = async (id) => {
    ...
    try {
      await api.put(`calls/${id}/`, {
        ...
        status: "Follow Up",
        notes: call.notes,
        follow_up: call.follow_up || today,
      });
  ...
  return (
    <div>
      ...
      <h2 className="text-xl text-cyan-300 mb-4">Leads (Interested Clients)</h2>
          ...
          <table className="w-full text-white text-sm table-auto">
            ...
            <tbody>
              {filteredLeads.map((call) => (
                ...
                >
                  <td className="py-3 px-3">{call.name}</td>

                  <td className="px-3">{call.phone}</td>

                  <td className="px-3">{call.project || "-"}</td>
                ...
                <td className="px-3">
                  ...
                  <td className="px-3 text-center">
                    <div className="flex justify-center items-center gap-4">
                      ...
                      <button
                        onClick={() => convertToFollowUp(call.id)}
                        className="cursor-pointer text-yellow-400 border border-yellow-400 px-2 py-1 rounded text-xs hover:text-white hover:scale-105 transition"
                      >
                        Follow Up
                      </button>
